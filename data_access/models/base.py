...
class FiscalProfile(models.Model):
    ...
    def create_profile(
        ...
        Args:
            admin (User): Instancia del usuario administrador (User) para la entidad de Ledger.
            entity_name (str): Nombre explícito y legal para la entidad contable (EntityModel).
            use_accrual_method (bool): Indica si se utiliza el método de acumulación o devengo.
